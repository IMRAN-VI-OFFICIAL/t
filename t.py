#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To IMRAN
...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               IMRAN_VI_OFFICIAL               |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|
 
\033[1;91m [⚡\033[1;97mAuthor Name: IMRAN_VI     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: HI_GAMEPLAY ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: BANGLADESH      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mIMRAN\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:IMRAN_VI
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe HI_GAMEPLAY Youtube Channel " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mIMRAN\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
